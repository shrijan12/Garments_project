                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="/outletqueries" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Outlet Query</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Outlet Query view</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($contacts as $q)
                        <tr>
                            ...
                            <td>{{$q->contact_subject}}</td>
                            <td>{{$q->contact_message}}</td>

                            <td>
                                <button type="button" class="btn btn-block btn-danger" onclick="document.getElementById('delete-{{ $q->id }}').submit();">
                                    <strong style="color: white;">Delete</strong>
                                </button>
                                <form id="delete-{{ $q->id }}" action="/outletqueries/{{ $q->id }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
