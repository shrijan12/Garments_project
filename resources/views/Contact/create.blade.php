            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/contacts/create" class="nav-link active">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card" style="background-color: white">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form role="form" method="post" action="/contacts" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Contact Heading</label>
                                        <input type="text"  class="form-control" name="contact_heading" placeholder=" Contact Heading">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Contact Map_url</label>
                                        <input type="url"  class="form-control" name="Contact_Url" placeholder="Contact_Url">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Outlet Heading</label>
                                        <input type="text"  class="form-control" name="outlet_heading" placeholder="Place Outlet Heading">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Outlet Map_url</label>
                                        <input type="url"  class="form-control" name="Outlet_Url" placeholder="Outlet Url">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="Icons">Contact Button</label>
                                        <input type="text" class="form-control" id="icons" name="contact_button" placeholder="Name for Contact Button">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="Icons">Outlet Button</label>
                                        <input type="text" class="form-control" id="icons" name="outlet_button" placeholder="Name for outlet button">
                                    </div>
                                </div>
