        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card" style="background-color: white">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form role="form" method="post" action="/contactdetails/{{$contactDetail->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="product_name" name="contact_name" placeholder="Contact Name" value="{{old('contact_name')??$contactDetail->contact_name}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="product_code" name="contact_icons" placeholder="Contact Icons" value="{{old('contact_icons')??$contactDetail->contact_icons}}">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="Icons">Contact Content</label>
                                        <input type="text" class="form-control" id="icons" name="contact_content" placeholder="Product content for contact" value="{{old('contact_content')??$contactDetail->contact_content}}">
                                    </div>
                                </div>
                            </div>
                            <br>
