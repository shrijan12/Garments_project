                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($contact as $c)
                        <tr>
                            ...
                            <td>{{$c->contact_icons}}</td>
                            <td>{{$c->contact_content}}</td>
                            <td>
                                <a href="/contactdetails/{{ $c->id }}/edit" style="text-decoration: none;">
                            ...
                            <td>
                                ...
                                <form id="delete-{{ $c->id }}" action="/contactdetails/{{ $c->id }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
