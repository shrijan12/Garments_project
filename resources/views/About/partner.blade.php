    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Services view items</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                    <tr>
                        <th>Partner heading</th>
                        <th>Partner Heading Desc</th>
                        <th>Partner Logo</th>
                        <th>Edit</th>
                        <th>Delete</th>
                    ...
                    @foreach($partners as $partner)
                        <tr>
                            <td>{{$partner->about->partners_heading}}</td>
                            <td>{{substr(strip_tags($partner->about->partners_head_desc),0,2000)}}</td>
                            <td><img src="/storage/{{$partner->partners_image}}" height="140px" width="120px"> </td>
                            <td>
                                <a href="/homeContent/{{ $partner->id }}/edit" style="text-decoration: none;">
                                    <button type="button" class="btn btn-block btn-warning">
                                        <strong style="color: white;">Edit</strong>
                                    </button>
                                </a>
                            </td>
                            <td> <button type="button" class="btn btn-block btn-danger" onclick="document.getElementById('delete-{{ $partner->id }}').submit();">
                                    <strong style="color: white;"><i class="fa fa-trash"></i> Delete</strong>
                                </button>
                                <form id="delete-{{ $partner->id }}" action="/partner/{{ $partner->id }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
