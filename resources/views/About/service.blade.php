                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($services as $service)
                        <tr>
                            ...
                            <td>{{$service->service_logo_desc}}</td>
                            <td><button class="btn btn-primary"><i class="fa fa-eye"></i> View</button></td>
                            <td>
                                <a href="/homeContent/{{ $service->id }}/edit" style="text-decoration: none;">
                                    <button type="button" class="btn btn-block btn-warning">
                                        <strong style="color: white;">Edit</strong>
                                    </button>
                                </a>
                            </td>
                            <td> <button type="button" class="btn btn-block btn-danger" onclick="document.getElementById('delete-{{ $service->id }}').submit();">
                                    <strong style="color: white;"><i class="fa fa-trash"></i> Delete</strong>
                                </button>
                                <form id="delete-{{ $service->id }}" action="/service/{{ $service->id }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
