            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/banner/create" class="nav-link active">
                                    <i class="fa  fa-arrow-circle-right nav-icon"></i>
                                    <p>Create Banner</p>
                                </a>
                            </li>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card" style="background-color: white">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form role="form" method="post" action="/banner" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label> Banner Header</label>
                                        <input type="text"  class="form-control" name="banner_header" placeholder="Place Banner Heading">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" rows="5" class="form-control" name="banner_content" placeholder="Enter Banner Content"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="banner_button" placeholder="Enter Banner Button Name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Carousel Icon 1</label>
                                        <input type="text" class="form-control" name="carousel_icon1" placeholder="Enter Carousel Icon1">
                                        <small>Please search for the icons on <a href="https://boxicons.com/"></a> </small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Carousel Icon 2</label>
                                        <input type="text" class="form-control" name="carousel_icon2" placeholder="Enter Carousel Icon1">
                                        <small>Please search for the icons on <a href="https://boxicons.com/"></a> </small>
                                    </div>
                                </div>
                                <div class="col-lg-6">
