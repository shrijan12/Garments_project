    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Banner view items</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($banners as $banner)
                        <tr>
                            ...
                            <td>{{$banner->carousel_icon1}}</td>
                            <td>{{$banner->carousel_icon2}}</td>
                            <td>
                                <a href="/banner/{{ $banner->id }}/edit" style="text-decoration: none;">
                                    <button type="button" class="btn btn-block btn-warning">
                                        <strong style="color: white;">Edit</strong>
                                    </button>
                                </a>
                            </td>
                            <td> <button type="button" class="btn btn-block btn-danger" onclick="document.getElementById('delete-{{ $banner->id }}').submit();">
                                    <strong style="color: white;"><i class="fa fa-trash"></i> Delete</strong>
                                </button>
                                <form id="delete-{{ $banner->id }}" action="/banner/{{ $banner->id }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
