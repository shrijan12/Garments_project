    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">HomeContent view items</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                    <tr>
                        <th>About_us Heading</th>
                        <th>Outlet Heading</th>
                    ...
                    <tbody>
                    @foreach($content as $homecontent)
                        <tr>
                            <td>{{$homecontent->aboutus_heading}}</td>
                            <td>{{$homecontent->outlet_heading}}</td>
                            <td>{{$homecontent->factory_heading}}</td>
                            <td>
                                <a href="/homeContent/{{ $homecontent->id }}/edit" style="text-decoration: none;">
                            ...
                            <td> <button type="button" class="btn btn-block btn-danger" onclick="event.preventDefault();
                                ...
                                <form id="delete-form" action="/homeContent/{{ $homecontent->id }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form></td>
                        </tr>
