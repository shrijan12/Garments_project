                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="/homeContent" class="nav-link active">
                                    <i class="fa  fa-arrow-circle-right nav-icon"></i>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card" style="background-color: white">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form role="form" method="post" action="/homeContent/{{$homeContent->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control" name="aboutus_heading" placeholder="Place About-Us heading" value="{{old('aboutus_heading')??$homeContent->aboutus_heading}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> About_us Image </label>
                                        <input type="file"  class="form-control" name="aboutus_image" placeholder="Place About-Us Image" value="{{old('aboutus_image'??$homeContent->aboutus_image)}}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label> About_us Description</label>
                                        <textarea class="textarea" name="aboutus_content" placeholder="Place About-Us Description"
                                                  style="width: 100%; height: 180px; font-size: 14px; line-height: 7px; border: 1px solid #dddddd; padding: 10px;">{{old('aboutus_content')??$homeContent->aboutus_content}}</textarea>                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Factory Heading</label>
                                        <input type="text"  class="form-control" name="factory_heading" placeholder="Place Factory Heading" value="{{old('factory_heading')??$homeContent->factory_heading}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="textarea" name="factory_content" placeholder="Place Factory Description here"
                                                  style="width: 100%; height: 180px; font-size: 14px; line-height: 7px; border: 1px solid #dddddd; padding: 10px;">{{old('factory_content')??$homeContent->factory_content}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Outlets Heading</label>
                                        <input type="text"  class="form-control" name="outlet_heading" placeholder="Place Outlets Heading" value="{{old('outlet_heading')??$homeContent->outlet_heading}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="textarea" name="outlet_content" placeholder="Place Outlet Description here"
                                                  style="width: 100%; height: 180px; font-size: 14px; line-height: 7px; border: 1px solid #dddddd; padding: 10px;">{{old('outlet_content')??$homeContent->outlet_content}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <br>
                            <button type="submit" value="submit" class="btn btn-primary">Update</button> &nbsp;
                            <button type="reset" class="btn btn-secondary" onclick="window.history.go(-1)">Cancel</button>
