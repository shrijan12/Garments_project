        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card" style="background-color: white">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form role="form" method="post" action="/footer/{{$footer->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="desc1" placeholder="Enter Company Details details" value="{{old('desc1')??$footer->desc1}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> year</label>
                                        <input type="text" class="form-control" name="year" placeholder="Enter copyright Year" value="{{old('year')??$footer->year}}">
                                    </div>
                                </div>
                            </div>
                            <br>
