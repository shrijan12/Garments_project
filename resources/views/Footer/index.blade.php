                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($footer as $foot)
                        <tr>
                            ...
                            <td>{{$foot->year}}</td>
                            <td>
                                <a href="/footer/{{ $foot->id }}/edit" style="text-decoration: none;">
                            ...
                            <td>
                                <button type="button" class="btn btn-block btn-danger" onclick="document.getElementById('delete-{{ $foot->id }}').submit();">
                                    <strong style="color: white;">Delete</strong>
                                </button>
                                <form id="delete-{{ $foot->id }}" action="/footer/{{ $foot->id }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
