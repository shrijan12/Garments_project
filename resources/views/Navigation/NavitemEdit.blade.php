                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="/navitem" class="nav-link active">
                                    <i class="fa  fa-arrow-circle-right nav-icon"></i>
                                    <p>View Nav Items</p>
                                </a>
                            </li>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Navitems Edit</li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="card" style="background-color: white">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form role="form" method="post" action="/navitem/{{$navitem->id}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')
                                      <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('nav_name') is-invalid @enderror" id="nav_name" name="nav_name" value="{{old('nav_name')??$navitem->nav_name}}" placeholder="Home, Contact....">
                                                    @error('nav_name')
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('nav_url') is-invalid @enderror" id="icons" name="nav_url" placeholder="/,/about,/product/" value="{{old('nav_url')??$navitem->nav_url}}">
                                                    @error('nav_url')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
