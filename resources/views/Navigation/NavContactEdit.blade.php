                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="/navcontact" class="nav-link active">
                                    <i class="fa  fa-arrow-circle-right nav-icon"></i>
                                    <p>View NavContact </p>
                                </a>
                            </li>
                    ...
                    <div class="col-lg-8">
                        <div class="card" style="background-color: white">
                            <div class="card-header">
                                <h3 class="card-title">Edit Navigation Items</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form role="form" method="post" action="/navcontact/{{$navcontact->id}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('contact_item') is-invalid @enderror" id="nav_name" value="{{old('contact_item')??$navcontact->contact_item}}" name="contact_item" placeholder="Contact Name">
                                                @error('contact_item')
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('contact_url') is-invalid @enderror" id="icons" name="contact_url" value="{{old('contact_url')??$navcontact->contact_url}}" placeholder="Contact Url">
                                                @error('contact_url')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('contact_icons') is-invalid @enderror " id="icons" name="contact_icons" value="{{old('navcontact')??$navcontact->contact_icons}}" placeholder="Contact Icons">
                                                @error('contact_icons')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <button class="btn btn-primary buttons"  value="submit" type="submit">Update</button>
                                    <button class="btn btn-warning buttons" onclick="window.history.go(-1)" >Cancel</button>
                                </form>
                            </div>
                            <!-- /.card-body -->
                        </div>
