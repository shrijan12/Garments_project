            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Navigation Items View</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                            <tr>
                                <th>Nan_contact Name</th>
                                <th>Nav_contact Url</th>
                                <th>Nav_contact Icons</th>
                                <th>Edit</th>
                                <th>Delete</th>
                            </tr>
                            </thead>
                            ...
                            @foreach($navcontacts as $navcontact)
                                <tr>
                                    <td>{{$navcontact->contact_item}}</td>
                                    <td>{{$navcontact->contact_url}}</td>
                                    <td>{{$navcontact->contact_icons}}</td>
                                    <td>
                                        <a href="/navcontact/{{$navcontact->id}}/edit"><button class="btn btn-secondary">
                                            <i class="fa fa-edit"></i> Edit
                                        </button></a>
                                    </td>
                                    <td> <button type="button" class="btn btn-block btn-danger" onclick="document.getElementById('delete-{{ $navcontact->id }}').submit();">
                                            <strong style="color: white;"><i class="fa fa-trash"></i> Delete</strong>
                                        </button>
                                        <form id="delete-{{ $navcontact->id }}" action="/navcontact/{{ $navcontact->id }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
