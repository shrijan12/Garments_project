                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($navitems as $navitem)
                                <tr>
                                    ...
                                    <td>{{$navitem->nav_url}}</td>
                                    <td>
                                        <a href="/navitem/{{$navitem->id}}/edit"><button class="btn btn-secondary">
                                            <i class="fa fa-edit"></i> Edit
                                        </button></a>
                                    </td>
                                    <td> <button type="button" class="btn btn-block btn-danger" onclick="document.getElementById('delete-{{ $navitem->id }}').submit();">
                                            <strong style="color: white;"><i class="fa fa-trash"></i> Delete</strong>
                                        </button>
                                        <form id="delete-{{ $navitem->id }}" action="/navitem/{{ $navitem->id }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
