            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Social View Items</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($social as $socials)
                                <tr>
                                    <td>{{$socials->social_name}}</td>
                                    <td>{{$socials->icons}}</td>
                                    <td>{{$socials->icon_url}}</td>
                                    <td>{{$socials->navigation->id}}</td>
                                    <td> <button type="button" class="btn btn-block btn-danger" onclick="event.preventDefault();
                                        ...
                                        <form id="delete-form" action="/social/{{ $socials->id }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
