                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($products as $product)
                        <tr>
                            ...
                            <td><img src="/storage/{{$product->product_image}}" height="140px" width="120px"> </td>
                            <td>
                            ...
                            <td>
                                <button type="button" class="btn btn-block btn-danger" onclick="document.getElementById('delete-{{ $product->id }}').submit();">
                                    <strong style="color: white;">Delete</strong>
                                </button>
                                <form id="delete-{{ $product->id }}" action="/product/{{ $product->id }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
