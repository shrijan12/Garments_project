                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="product_code" name="product_code" placeholder="Product Code" value="{{old('product_code')??$product->product_code}}">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="Icons">Product_short_description</label>
                                        <input type="text" class="form-control" id="icons" name="product_short_description" placeholder="Product Short Description" value="{{old('product_short_description')??$product->product_short_description}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="textarea" id="product_features" name="product_features" placeholder="Product Features">
                                         {{old('product_features')??$product->product_features}}
                                        </textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tags" name="tags" placeholder="Tags" value="{{old('tags')??$product->tags}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Product Image</label>
                                        <input type="file" class="form-control" id="product_image" name="product_image" placeholder="Product Image" value="{{old('product_image')??$product->product_image}}">
                                    </div>
                                </div>
                            </div>
                            <br>
